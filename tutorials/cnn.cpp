...
void cnn_tutorial() {
    auto X = Data::read_data("../data/fashion_mnist_x2.txt");
    auto Y = Data::read_data("../data/fashion_mnist_y2.txt");
    ...
    // training
    auto model = ConvolutionalNeuralNetwork(X_train, Y_train_prepared, 10, 28, 28);
