...
ConvolutionalNeuralNetwork::ConvolutionalNeuralNetwork(const Data::set& X_train, const Data::set& Y_train, const std::vector<int>& layer_dimensions) {
    ...
    ConvolutionalNeuralNetwork::vector Y_temp = ConvolutionalNeuralNetwork::vector(Y_train[0].size());
...
Data::set ConvolutionalNeuralNetwork::predict(const Data::set& X_test) {
